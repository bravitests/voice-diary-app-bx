...
export const metadata: Metadata = {
  ...
  description: "Transform your thoughts into a personal audio diary with AI transcription, smart insights, and emotional analysis. Free voice journaling app.",
  keywords: "voice diary, audio journaling, AI transcription, voice notes, digital diary, speech to text, personal journal, voice recorder, AI insights",
  twitter: {
            ...
            <div className="text-center space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed px-4">
                  Record audio diaries, get AI transcription & emotional insights. Free voice journaling app.
                </p>
              </div>
            </div>
